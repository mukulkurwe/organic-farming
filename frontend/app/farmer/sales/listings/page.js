          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <input
                ...
                onChange={(e) => {
                  set("crop_name", e.target.value);
                  const match = crops.find((c) => c.name === e.target.value);
                  if (match) set("crop_id", match.id);
                }}
...
export default function ListingsPage() {
  ...
  const filtered = listings.filter(
    (l) => !search || l.crop_name.toLowerCase().includes(search.toLowerCase()),
  );
        ...
        {loading ? (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl border border-gray-100 p-5 h-48 animate-pulse"
              >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filtered.map((listing) => (
              <div
                key={listing.id}
                className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-md transition hover:border-gray-300"
              >
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>
                      <span className="font-semibold text-gray-800">
                        {Number(listing.quantity_available).toFixed(0)}
                      </span>{" "}
                      / {Number(listing.quantity_kg).toFixed(0)} {listing.unit}{" "}
                      available
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <div className="mb-4">
                  <div className="flex justify-between text-xs text-gray-400 mb-1">
                    ...
                    <span>
                      {listing.quantity_kg > 0
                        ? Math.round(
                            (listing.quantity_available / listing.quantity_kg) *
                              100,
                          )
                        : 0}
                      %
                  ...
                  <div className="w-full bg-gray-100 rounded-full h-1.5">
                    <div
                      ...
                      style={{
                        width: `${listing.quantity_kg > 0 ? (listing.quantity_available / listing.quantity_kg) * 100 : 0}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  <div className="flex gap-1">
                    <button
                      onClick={() =>
                        router.push(
                          `/farmer/sales/transactions/new?listing_id=${listing.id}`,
                        )
                      }
